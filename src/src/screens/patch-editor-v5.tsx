...
/**
 * Patch editor v5 — the node-graph design.
 *
 ...
 *
 * Named `patch-editor-v5.tsx` (rather than `patch-editor.tsx`) to
 * avoid colliding with the legacy v4 screen at `screens/patch-editor.tsx`
 * that's still imported by `program-patch-editor.stories.tsx` for
 * reference. v4 will be deleted once we're confident nothing wants
 * to refer back to it.
 */
