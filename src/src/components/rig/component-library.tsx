...
import {
  RIG_COMPONENT_CATALOG,
  type RigComponentGroup,
  ...
  return (
    <div className={"flex h-full flex-col gap-3 " + (className ?? "")}>
      <div className="px-1 text-[10px] leading-tight text-muted-foreground">
        Generic building blocks. Future iterations will add pre-configured
        complex devices (e.g. a single &ldquo;Launchkey 49&rdquo; that brings
        its keyboard, pads, knobs, and faders pre-wired).
      </div>
