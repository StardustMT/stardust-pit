...
export const Default: StoryObj<typeof PluginBrowser> = {
  args: {
    plugins: [
      ...
      { id: "surge", name: "Surge XT", vendor: "Surge Synth Team", format: "CLAP", category: "Instrument" },
      { id: "vital", name: "Vital", vendor: "Vital Audio", format: "VST3", category: "Instrument" },
      { id: "muse", name: "MuseSounds Strings", vendor: "Muse Group", format: "VST3", category: "Instrument" },
      { id: "bbc", name: "BBC SO Discover", vendor: "Spitfire Audio", format: "VST3", category: "Instrument" },
      { id: "labs", name: "LABS — Soft Piano", vendor: "Spitfire Audio", format: "VST3", category: "Instrument" },
      { id: "dexed", name: "Dexed", vendor: "asb2m10", format: "VST3", category: "Instrument" },
      { id: "supermassive", name: "Valhalla Supermassive", vendor: "Valhalla DSP", format: "VST3", category: "Effect" },
      ...
      { id: "decapitator", name: "Decapitator", vendor: "Soundtoys", format: "VST3", category: "Effect" },
    ],
  },
}
