...
export const AllGreen: StoryObj<typeof PreShowValidation> = {
  args: {
    checks: [
      ...
      { status: "pass", category: "Audio", detail: "Focusrite Scarlett 18i20 · 128 / 48 kHz · 7.2 ms" },
      ...
      { status: "pass", category: "Show file", detail: "hamilton-2026.stardust · valid · no missing samples" },
    ],
  },
}
